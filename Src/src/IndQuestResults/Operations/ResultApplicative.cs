...
public static class ResultApplicative
{
        ...
        Func<T1, T2, T3, TResult> func)
    {
        if (result1 == null) throw new ArgumentNullException(nameof(result1));
        if (result2 == null) throw new ArgumentNullException(nameof(result2));
        if (result3 == null) throw new ArgumentNullException(nameof(result3));
        if (func == null) throw new ArgumentNullException(nameof(func));
        ...
        Func<T1, T2, T3, T4, TResult> func)
    {
        ...
        if (result2 == null) throw new ArgumentNullException(nameof(result2));
        if (result3 == null) throw new ArgumentNullException(nameof(result3));
        if (result4 == null) throw new ArgumentNullException(nameof(result4));
        if (func == null) throw new ArgumentNullException(nameof(func));
        ...
        Func<T1, T2, T3, T4, T5, TResult> func)
    {
        ...
        if (result3 == null) throw new ArgumentNullException(nameof(result3));
        if (result4 == null) throw new ArgumentNullException(nameof(result4));
        if (result5 == null) throw new ArgumentNullException(nameof(result5));
        if (func == null) throw new ArgumentNullException(nameof(func));
